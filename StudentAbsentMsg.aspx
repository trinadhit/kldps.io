<%@ Page Title="" Language="C#" MasterPageFile="~/EduMaster.master" AutoEventWireup="true" CodeFile="StudentAbsentMsg.aspx.cs" Inherits="StudentAbsentMsg" EnableEventValidation="false" %>
                    ...
                    <div style="width: 100%; text-align: center">
                        <table style="width: 100%; text-align: center">
                            ...
                            <td>
                                ...
                                <%-- <tr>
                            <td align="center">
                                <asp:Label ID="lblschoolname" CssClass="lblschoolname" Text="SEND STUDENT ABSENT MESSAGES TO PARENTS" runat="server"></asp:Label>
                                <br />
                                <br />
                            </td>
                        ...
                        <tr>
                            <td align="center">
                                <fieldset style="border-color: cadetblue; border-bottom-width: thick">
                                    <legend align="center" style="vertical-align: central; font-family: 'Comic Sans MS'; font-size: 18pt; font-weight: bold; color: cadetblue">SEND STUDENT ABSENT MESSAGES TO PARENTS</legend>
                                    <table>
                                        <tr>
                                            <td align="right" valign="middle" style="height: 20PX; width: 41%; color: cadetblue">
                                    ...
                                    <table>
                                        <tr>
                                            <td align="right"><span style="font-weight: bold">From Date:</span></td>
                                            <td align="left">
                                                <input type="text" id="txtfdd" name="txtfdd" readonly required="required" maxlength="2" style="width: 30px; height: 25px" placeholder="DD" runat="server" onkeypress="return isNumber(event)" class="text" />
                                                <input type="text" id="txtfmm" name="txtfmm" readonly required="required" maxlength="2" style="width: 30px; height: 25px" placeholder="MM" runat="server" onkeypress="return isNumber(event)" class="text" />
                                                <input type="text" id="txtfyyyy" name="txtfyyyy" readonly required="required" maxlength="4" style="width: 50px; height: 25px" placeholder="YYYY" runat="server" onkeypress="return isNumber(event)" class="text" /></td>

                                            <td></td>
                                            <td align="right"><span style="font-weight: bold">To Date:</span></td>
                                            <td align="left">
                                                <input type="text" id="txttdd" name="txttdd" readonly required="required" maxlength="2" style="width: 30px; height: 25px" placeholder="DD" runat="server" onkeypress="return isNumber(event)" class="text" />
                                                <input type="text" id="txttmm" name="txttmm" readonly required="required" maxlength="2" style="width: 30px; height: 25px" placeholder="MM" runat="server" onkeypress="return isNumber(event)" class="text" />
                                                <input type="text" id="txttyyyy" name="txttyyyy" readonly required="required" maxlength="4" style="width: 50px; height: 25px" placeholder="YYYY" runat="server" onkeypress="return isNumber(event)" class="text" />
                                            </td>
                                        </tr>
                                    </table>
                                </fieldset>
                                ...
                                <table>
                                    <tr>
                                        <td colspan="3" style="text-align: center">
                                            <input type="submit" id="btngetdtls" name="btngetdtls" runat="server" value="Get Details" class="btn btn-success" style="width: 150px"
                                                onserverclick="btngetdtls_Click" onclick="return dropdownvalidation();" />
                                            <input type="submit" id="btnclear1" name="btnclear1" runat="server" value="Clear" class="btn btn-success" onserverclick="btnclear1_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="NAME">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblgender" Text='<%# Eval("GENDER") %>' runat="server" Visible="false"></asp:Label>
                                                        </ItemTemplate>
                                                        <ItemStyle HorizontalAlign="Left" />
                                                    </asp:TemplateField>
                        ...
                        <tr runat="server" visible="false" id="trSave">
                            <td colspan="4" align="center">
                                <table>
                                    <tr>
                                        <td>
                                            <input type="submit" id="btnsendmsg" name="btnsendmsg" runat="server" value="Send Message" class="btn btn-success" style="width: 130px"
                                                onserverclick="btnsendmsg_Click" />
                                            <input type="submit" id="btnclear" name="" runat="server" value="Clear" class="btn btn-success" onserverclick="btnclear_Click" />
                                        </td>
                                    </tr>
                                </table>
                            </td>
